...
x_test = x_test.reshape((len(x_test),(x_test.shape[1]),(x_train.shape[2]),1))
print(x_train.shape)
print(x_test.shape)
...
x = Conv2D(1,(3,3), activation="relu", input_shape=(28,28,1))(input_img)
# x = Dense(50, activation="relu")(x)
# x = Dense(100, activation="relu")(x)
x = Conv2D(10,(5,5), activation="relu")(x)
x = Conv2D(10,(3,3), activation="relu")(x)
x = Conv2D(10,(7,7), activation="relu")(x)

encoded = Conv2D(encoding_dim,(8,8), activation="relu")(x)
# x = Dense(100, activation="relu")(encoded)
# x = Dense(50, activation="relu")(x)

# x = Conv2D(1,(2,2), activation="relu")(x)
# x = UpSampling2D(2)(encoded)
#디코더는 입력의 손실있는 재구성 (lossy reconstryction)
decoded = Conv2D(1,(2,2), activation="relu",padding="same")(encoded)
...
history = autoencoder.fit(x_train, x_train, epochs = 10, batch_size=500, shuffle = True, validation_data=(x_test,x_test))
