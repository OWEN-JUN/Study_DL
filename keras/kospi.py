...
print(x_train.shape)
print(y_train.shape)
x_tr, x_t, y_tr, y_t = train_test_split(x_train, y_train, random_state=66, test_size = 0.2)

###x_train shape (593, 7, 6, 1)
model = Sequential()
model.add(LSTM(30, input_shape=(x_tr.shape[1],1),return_sequences=True))
...
model.fit(x_tr,y_tr,epochs=5000, verbose=2)
